...
import de.ni.fun.battleship.control.network.server.methods.LoginBattleShipUserMethod;
...
public class BattleshipServer extends Server {
    ...
    public BattleshipServer(int port, boolean autoRegistrerEveryLient, boolean keepConnectionAlive, boolean useSSL) {
        ...
        PlayerRegistry.getInstance(); //Stellt sicher, dass die Playerregistry initialisiert ist.
    }
    ...
    public void preStart() {
        ...
        this.registerMethod(MethodID.LOGINBATTLESHIPUSER, new LoginBattleShipUserMethod(this));
